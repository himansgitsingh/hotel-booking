      ...
      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll'>
        ...
        <tbody className='text-sm'>
          {dashboardData.bookings.map((item,index)=>(
            <tr key={index}>
             <td className='py-3 px-4 text-gray-700 borrder-t border-gray-300'>
              {item.user.username}
             </td>

            <td className='py-3 px-4 text-gray-700 borrder-t border-gray-300 max-sm:hidden'>
              {item.room.roomType}
             </td>

              <td className='py-3 px-4 text-gray-700 borrder-t border-gray-300 text-center'>
              ₹ {item.totalPrice}
             </td>

             <td className='py-3 px-4 border border-gray-300 flex'>
